...
public class ReceiveTwoActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_receive_two);
		timer = new Timer();
		findView();
		setTimerTask();
		initAction();
	...
	private void findView() {
		...
		headerLayout.showTitle("节点二最新数据");
		headerLayout.showLeftBackButton(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				ReceiveTwoActivity.this.finish();
			}
		});
	...
	private XYMultipleSeriesRenderer getSOdemorenderer(String state) {
		...
		render3.setYAxisMax(150);// 设置y轴的范围
